...
const DESCRIPTION = "Próximamente conocerás las marcas que formarán parte de Central Santa Rosa de Lima.";
  ...
  return (
    <>
      ...
      <Section className="py-12 md:py-16">
         <ContentPlaceholder title="Próximamente conocerás las marcas que formarán parte de Central Santa Rosa de Lima." />
      </Section>
    </>
  );
}
